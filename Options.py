...
class Options:
    def __init__(self, window):
        ...
        self.scaleLabel = Label(self.root, text="Scale")
        self.scaleLabel.pack(in_=self.f)
        self.scale = Spinbox(self.root, from_=.0001, to=1)
        self.scale.delete(0,"end")
        self.scale.insert(0, self.window.scale)
        self.scale.pack(in_=self.f)
